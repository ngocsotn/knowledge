# Infrastructure-Level Rate Limiting & Throttling
...
### Q1: Why is rate-limiting at the API Gateway or Nginx level preferred over backend-level rate-limiting?
- **Answer:** Resource Conservation. If you rate-limit inside your backend application, the request has already consumed connection threads, traversed network routes, and parsed HTTP headers, wasting CPU and memory resources. Throttling at Nginx or API Gateway levels blocks malicious or spam traffic at the perimeter before it can ever touch and starve backend application nodes.
