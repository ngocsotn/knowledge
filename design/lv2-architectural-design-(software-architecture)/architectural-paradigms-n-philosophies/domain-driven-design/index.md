...
### Q1: What is an Aggregate Root in DDD?
- **Answer:** An Aggregate is a cluster of associated domain objects treated as a single transactional unit. The **Aggregate Root** is the gatekeeper entity. External code cannot modify any object inside the aggregate directly; all state changes must be routed through public methods of the Aggregate Root, guaranteeing absolute encapsulation and business consistency.
