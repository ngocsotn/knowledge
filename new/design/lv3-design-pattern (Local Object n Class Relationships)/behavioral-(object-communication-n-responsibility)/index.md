...
### Q1: How does the Strategy pattern adhere to the Open/Closed Principle (OCP)?
- **Answer:** Strategy encapsulates interchangeable algorithms inside separate classes implementing a shared interface. To introduce a new algorithm (e.g., adding a new payment gateway), you simply write a new strategy class. You do not modify any existing client or router code, satisfying the Open/Closed Principle completely.
